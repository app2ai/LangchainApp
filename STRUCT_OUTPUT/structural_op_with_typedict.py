...
class UserInfo(TypedDict):
    key_themes: Annotated[list[str], "List down all Key themes user added in there review"]
    summary: Annotated[str, "A brief summary of the user's information"]
    age: Optional[Annotated[int, "The user's age"]]
    email: Optional[Annotated[str, "The user's email address"]]
    sentiment: Annotated[bool, "Indicates the user's sentiment"]
    pros: Annotated[list[str], "A list of positive attributes"]
    cons: Annotated[list[str], "A list of the user's negative attributes"]
